...
public abstract class TextServiceStub implements BackgroundResource {
  ...
  public UnaryCallable<BatchEmbedTextRequest, BatchEmbedTextResponse> batchEmbedTextCallable() {
    throw new UnsupportedOperationException("Not implemented: batchEmbedTextCallable()");
  }

  public UnaryCallable<CountTextTokensRequest, CountTextTokensResponse> countTextTokensCallable() {
    throw new UnsupportedOperationException("Not implemented: countTextTokensCallable()");
  }
